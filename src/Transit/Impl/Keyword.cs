...
namespace Beerendonk.Transit.Impl
{
    ...
    internal class Keyword : IKeyword, INamed, IComparable, IComparable<IKeyword>, IEquatable<IKeyword>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is Keyword && ((Keyword)obj).Value.Equals(Value);
        }
        ...
        { 
            return Value.CompareTo(((Keyword)other).Value); 
        }
        ...
        /// </returns>
        /// <exception cref="System.ArgumentException">obj must be an IKeyword.</exception>
